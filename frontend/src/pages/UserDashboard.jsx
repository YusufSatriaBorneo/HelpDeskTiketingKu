  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(
          `Gagal membuat tiket: ${errorData.message || errorData.error || "Terjadi kesalahan"}`,
        );
      }
    } catch (err) {
          ...
          <div>
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={{ color: "var(--text-secondary)", margin: 0 }}>
                Overview pembuatan tiket baru untuk penanganan IT.
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder="Contoh: 192.168.1.10 atau PC-User1"
                    required
                  />
                </div>
        ...
        {activeTab === "history" && (
          <div>
            <div style={{ marginBottom: "2rem" }}>
              ...
              <p style={{ color: "var(--text-secondary)", margin: 0 }}>
                Overview riwayat tiket yang pernah Anda buat.
              </p>
            </div>
